...
def split_x(dataset, timesteps):                   
    ...
    for i in range(len(dataset) - timesteps):      #(length : 10) - 5 = 5  # 즉, for i in 5 : 5번 반복하겠다(0.1.2.3.4) i=번마다 한칸씩 올라감 
        subset = dataset[i : (i + timesteps)]      #[0~4] 라는 데이터셋이 subset데이터값에 0,1,2,3,4개 들어감 
...
[[[ 1  2  3]
 ...
 [[17 18 19]
  ...
  [33 34 35]]
=======================
#마지막 x데이터 버림(사용x) / range(len(dataset) - timesteps+1) -> range(len(dataset) - timesteps)
 [[21 22 23]
  [25 26 27]
  [29 30 31]
  [33 34 35]
