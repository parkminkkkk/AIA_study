...
from tensorflow.python.keras.layers import Dense, Input, Conv1D, Flatten, Dropout, MaxPooling2D
import numpy as np
...
#2. 모델구성 
model = Sequential()
model.add(Conv1D(10,(2),padding='same',input_shape=(13,1))) 
...
loss : 33.111812591552734
r2스코어 0.662396418918975
'''