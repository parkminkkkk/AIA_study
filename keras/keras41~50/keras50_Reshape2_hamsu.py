...
from tensorflow.python.keras.layers import Dense, LSTM, Conv2D, Flatten, Dropout, MaxPooling2D, Input
...
conv2 = Conv2D(32, (3,3), padding='valid')(mp1)
conv3 = Conv2D(10, 3)(conv2) 
mp2 = MaxPooling2D()(conv3)                              #4차원
Flat1 = Flatten()(mp2)                                   #4->2차원 (Flatten)
Res1 = Reshape(target_shape=(25,10))(Flat1)              #2->3차원 (Reshape) 
conv4 = Conv1D(10, 3)(Res1)                              #3차원     
lstm1 = LSTM(784)(conv4)                                 #3->2차원 (LSTM)
Res2 = Reshape(target_shape=(28,28,1))(lstm1)            #2->4차원 (Reshape)
conv5 = Conv2D(32, (3,3), padding='same')(Res2)          #4차원
Flat2 = Flatten()(conv5)                                 #4->2차원 (Flatten)
