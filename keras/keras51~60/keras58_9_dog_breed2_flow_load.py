...
x_train = np.load(save_path + 'keras58_9_x_train.npy')
x_test = np.load(save_path + 'keras58_9_x_test.npy')
y_train = np.load(save_path + 'keras58_9_y_train.npy')
y_test = np.load(save_path + 'keras58_9_y_test.npy')
