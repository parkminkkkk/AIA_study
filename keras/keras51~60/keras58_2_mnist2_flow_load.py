...
x_train = np.load(save_path + 'keras58_2_x_train.npy')
x_test = np.load(save_path + 'keras58_2_x_test.npy')
y_train = np.load(save_path + 'keras58_2_y_train.npy')
y_test = np.load(save_path + 'keras58_2_y_test.npy')
...
'''
acc: 0.9856699705123901
val_acc: 0.9851999878883362
loss: 0.04468763247132301
val_loss: 0.05006231740117073
'''