...
x_train = np.load(save_path + 'keras58_1_x_train.npy')
x_test = np.load(save_path + 'keras58_1_x_test.npy')
y_train = np.load(save_path + 'keras58_1_y_train.npy')
y_test = np.load(save_path + 'keras58_1_y_test.npy')
...
'''
acc: 0.8974900245666504
val_acc: 0.9074000120162964
loss: 0.2788206934928894
val_loss: 0.272530198097229
'''