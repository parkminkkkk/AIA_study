...
path_data_imputer = "D:/study/_data/AIFac_pollution/train_pd_inter/"
path_data_inter = "D:/study/_data/AIFac_pollution/train_pd_inter/"
data_name_list = [
...
print(test_aws_dataset) #[131376 rows x 8 columns]
...
train_aws_dataset = train_aws_dataset.drop(['일시','연도','지점'],axis=1)
...
test_aws_dataset = test_aws_dataset.drop(['일시','연도','지점'],axis=1)
...
train_all_dataset['month'] = pd.to_numeric(train_all_dataset['month'].astype('Int8'))
train_all_dataset['day'] = pd.to_numeric(train_all_dataset['day'].astype('Int8'))
train_all_dataset['hour'] = pd.to_numeric(train_all_dataset['hour'].astype('Int8'))
...
test_all_dataset['month'] = pd.to_numeric(test_all_dataset['month'].astype('Int8'))
test_all_dataset['day'] = pd.to_numeric(test_all_dataset['day'].astype('Int8'))
test_all_dataset['hour'] = pd.to_numeric(test_all_dataset['hour'].astype('Int8'))
